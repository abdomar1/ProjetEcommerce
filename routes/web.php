...
Route::post('/envoyer-message', function (Illuminate\Http\Request $request) {
    ...
    // Envoyer l'email
    Mail::to('saloumasalmamalek@gmail.com')->send(new ContactMail($details));
...
//// afficher produit apartire de categorie dans l'accueil & page categorie
// Route::get('/produits/categorie/{id}', [HomeController::class, 'filterByCategory'])->name('produits.par.categorie');
