                ...
                <div class="mb-4">
                    ...
                    <div class="row" style="background-color:#D3D3D3;
                        ...
                        <label class="lab">Nom</label>
                            <input class="form-control active" type="text" placeholder="Votre Nom">
                        </div>
                        <div class="col-md-6 form-group">
                        <br></br>
                        <label class="lab">Prenom</label>
                            <input class="form-control active" type="text" placeholder="Votre Prenom">
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="lab">E-mail</label>
                            <input class="form-control active" type="text" placeholder="example@email.com">
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="lab">Télephone</label>
                            <input class="form-control active" type="text" placeholder="+212 67 45 77 89">
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="lab">Votre Adresse</label>
                            <input class="form-control active" type="text" placeholder="123 rue">
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="lab">Ville</label>
                            <input class="form-control active" type="text" placeholder="Votre ville">
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="lab">Code Postal</label>
                            <input class="form-control active" type="text" placeholder="123">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card border-secondary mb-5">
                    <div class="card-header bg-primary text-white">
                        <h4 class="font-weight-semi-bold m-0">Commande totale</h4>
                    </div>
                            <div class="card-body">
